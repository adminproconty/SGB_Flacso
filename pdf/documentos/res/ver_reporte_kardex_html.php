...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            <th style="width: 100%;text-align:center" class='midnight-blue'>REPORTE KARDEX</th>
        </tr>
        <tr>
    ...
    ?>
        ...
        <tr>
            <td class='silver' style="text-align: center"><?php echo $row['fecha_loginv'];?></td>
            <td class='silver' style="text-align: center"><?php echo $row['codigo_producto'];?></td>
            <td class='silver' style="text-align: center"><?php echo $row['nombre_producto'];?></td>
            <td class='silver' style="text-align: right">
                <?php 
