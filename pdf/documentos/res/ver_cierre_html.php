...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        ...
        $sql=mysqli_query($con, "select usr.user_name, fac.condiciones, sum(fac.total_venta) as total_venta,
            ...
            and ca.fecha_cc >= '".$fecha_ini." 01:00:00'

            and ca.fecha_cc <= '".$fecha_fin." 23:50:50'    
...
while ($row=mysqli_fetch_array($sql))
...

	{
        ...
        if ($row["condiciones"] == 4) {
            $ventas_credito = $row["total_venta"];
        ...
        ?>
            ...
            <tr>
                ...
                <th class='silver' style="width: 40%; text-align: left">A Crédito: </th>

                <th class='silver' style="width: 10%; text-align: right;">$<?php echo $ventas_credito; ?></th>
