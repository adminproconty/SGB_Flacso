...
<div class="table-responsive">
   <table class="table">
      <tr  class="info">
         ...
         <th>Categoría</th>
         <th>Estado</th>
         <th class='text-right'>P.Estudiantes</th>
		 <th class='text-right'>P.Flacso</th>
		 <th class='text-right'>P.Externo</th>
      ...
      <tr>
		 ...
		 <td><?php echo $simbolo_moneda;?><span class='pull-right'><?php echo number_format($precio_flacso,2);?></span></td>
		 <td><?php echo $simbolo_moneda;?><span class='pull-right'><?php echo number_format($precio_publico,2);?></span></td>
